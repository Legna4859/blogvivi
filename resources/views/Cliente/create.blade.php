        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong style="font-size: 20pt">Correo Electronico:</strong>
                    <input type="email" name="correo" class="form-control" placeholder="correo electronico" style="font-size: 20pt">
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong style="font-size: 20pt">Domicilio:</strong>
                    <input type="text" name="domicilio" class="form-control" placeholder="domicilio" style="font-size: 20pt">
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong style="font-size: 20pt">Direccion:</strong>
                    <input type="text" name="direccion" class="form-control" placeholder="direccion" style="font-size: 20pt">
                </div>
            </div>
            <div class="col-xs-4 col-sm-12 col-md-6">
                <div class="form-group">
                    <strong style="font-size: 20pt">Ciudad:</strong>
