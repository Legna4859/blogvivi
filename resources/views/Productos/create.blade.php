    ...
    <div class="row">
        <div class="col-lg-6 margin-tb">
            ...
            <div class="pull-right">
                <a class="btn btn-primary" href="{{url('Productos')}}" title="Go back"> <i class="material-icons">reply</i></a>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input class="form-control" name="tipo"
                              placeholder="tipo" style="font-size: 20pt">
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="number" name="ingreso" class="form-control" placeholder="ingreso"
                           value="" style="font-size: 20pt">
                </div>
            </div>
